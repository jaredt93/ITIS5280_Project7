    ...
    private ServiceConnection serviceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            if (bluetoothService != null) {
                ...
                Log.d(TAG, "Perform Device connection");
                // perform device connection
                //bluetoothService.connect(connectedDevice.getDevice().getAddress());
            }
            Log.d(TAG, "Null here");
        }
...
//        if (bluetoothService.scanner != null) {
...
//                public void run() {
//                    scanning = false;
//                    bluetoothService.scanner.stopScan(leScanCallback);
//                }
//            }, SCAN_PERIOD);
//
//            scanning = true;
//            Log.d("Project7", "scan start here");
//            bluetoothService.scanner.startScan(filters, scanSettings, leScanCallback);
//        } else {
//            scanning = false;
//            bluetoothService.scanner.stopScan(leScanCallback);
//        }
